...
setwd("~/Documents/GitHub/batting-model/Data/baseballdatabank-2019.2/core/")
...
df <- data.frame(names(bat_stats_people))
...
#birthCountry,birthStatebirthCitydeathYeardeathMonthdeathDay, deathCountry,deathState,
...
df <- data.frame(names(pitch_stats_people))
...
clean_bat_pitch_stats_people <- left_join(clean_bat_stats_people, pitch_stats_people, by = c("yearID", "pitcher_last_name", "pitcher_first_name"))
