...
setwd("~/Documents/GitHub/batting-model/Data/")
...
ab_pitcher_hitter_names_games <- left_join(each_ab_pitcher_hitter_names, games, by = "g_id") %>% 
  ...
  select(id_v2, g_id, team, inning,bottom_inning, number_up, ab_id,batter_id, batter_first_name,batter_last_name,pitcher_id,pitcher_first_name,
...
rm(games, pnames, each_ab, each_ab_pitcher_names, each_ab_pitcher_hitter_names, ab_pitcher_hitter_names_games, clean)
